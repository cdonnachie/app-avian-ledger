...
def test_get_public_key(cmd):
    ...
    assert bip32_chain_code == bytes.fromhex(
        "0322c8f681e7274e767cee09b8e41770e6d2afd504fd5f85dfaab3e1ff6cdfcc")
    ...
    assert bip32_chain_code == bytes.fromhex(
        "dc699bc018541f456df1ebd4dea516a633a6260e0a701eba143449adc2ca63f3")
    ...
    assert bip32_chain_code == bytes.fromhex(
        "efd851020a3827ba0d3fd4375910f0ed55dbe8c5d740b37559e993b1d623a956")
    '''
